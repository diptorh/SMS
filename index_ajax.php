                ...
                <div class="card-body">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="form-group">
                            <input type="text" class=" form-control" id="students_name" name='students_name'
                                placeholder="Students Name" value="<?php echo $e_name; ?>" required>

                        </div>

                        <div class="form-group">
                            <input type="text" class=" form-control" id="fathers_name" name='fathers_name'
                                placeholder="Fathers Name" value="<?php echo $e_fath; ?>">
                        </div>

                        <div class="form-group">
                            <input type="text" class=" form-control" id="mothers_name" name='mothers_name'
                                placeholder="Mothers Name" value="<?php echo $e_moth; ?>">
                        </div>
...
$(document).ready(function() {
    ...
    $('#create').click(function(e) {
        ...
        var mothers_name1 = $('#fathers_name').val();
        var students_dob1 = $('#teacher_dob').val();
        var students_class1 = $('#teacher_gender').val();
